...
const Navbar = () => {
  ...
  return (
    <nav className=" fixed  backdrop-blur-lg w-full z-[99] border-b border-zinc-400/30  transition duration-500 p-4
    ">

      <div className="container mx-auto">
        <div className="flex top justify-between flex-wrap max-sm:flex-col  items-center">
          <Link href={"/"}   className="link font-bold flex items-center  gap-4 text-white">
