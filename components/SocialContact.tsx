...
const SocialContact = () => {
  return (
    <div
     ...
     max-md:gap-6 md:flex-col  max-md:w-full items-center max-md:h-[100px] md:w-[50px]    "
    >
      {/* <Link
        ...
        justify-end items-start  text-neutral-400  md:flex-1 p-1  rounded-md transition-all  duration-100 
        shadow-lg
      ...
      <Link
        ...
        className=" flex justify-end items-start md:flex-1 p-1  rounded-md transition-all  duration-100 r
      ...
      <Link
        ...
        className=" flex justify-end items-start text-neutral-400  md:flex-1 p-1  rounded-md  transition-all  duration-100 r
