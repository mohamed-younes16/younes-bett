  ...
  return (
    <div className=" mt-16">
      ...
      <div className="text-center"> 
          ...
          <p className="text-5xl max-md:text-4xl font-bold"> TECH Experiences
          <span className=" h-4 w-4 inline-block bg-violet-600 rounded-full"></span></p>
      </div>
      ...
      <div className="mt-10">
        <VerticalTimeline animate={false} >
          ...
          contentArrowStyle={{borderRight:"10px white solid"}}
